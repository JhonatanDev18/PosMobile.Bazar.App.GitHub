...
public class ResponseBorrarCompraN6 {
    ...
    public ResponseBorrarCompraN6(boolean esValida, String mensaje, RespuestaBaseN6 respuesta, List<Object> listado) {
